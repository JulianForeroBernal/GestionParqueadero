...
public class ConnectionDB {
    ...
    public static Connection getConnection() throws SQLException { // Que el metodo sea static permite usarlo sin crear una instancia (objeto), recurriendo directamente a la clase
        // Connection es una interfaz de la librería java.sql (no está diciendo que lo que devuelve este metodo será un objeto de alguna clase que implementa esta interfaz), la cual nos ayuda a establecer conexión con la BD y trabajar/comunicarse con ella mediante los métodos de la interfaz.
